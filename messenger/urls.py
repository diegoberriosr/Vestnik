...
urlpatterns = [
    ...
    path('conversations/members/update', views.update_group_members, name='update group members'),
    path('groups/managers/update', views.update_group_admins, name='update group admins'),
